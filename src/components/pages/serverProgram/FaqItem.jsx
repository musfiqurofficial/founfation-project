          ...
          <div className="space-y-6">
            <Item title="Edgevana – AMD 7313 - 7313-256G-10G">
              <div className="grid grid-cols-2 gap-2 p-4">
                ...
                <p>Cores</p>
                <p className="font-normal">16 cores @ 3.0 GHz</p>
                <p>Boot</p>
                <p className="font-normal">1 x 480 GB SSD</p>
                <p>Storage</p>
                <p className="font-normal">1 TB NVMe + 2 TB NVMe</p>
                <p>Memory</p>
                <p className="font-normal">256 GB</p>
                <p>Network</p>
            ...
            <Item title="Edgevana – AMD 7313 - 7313- 512G-10G">
              <div className="grid grid-cols-2 gap-2">
                ...
                <p className="font-normal">1 TB NVMe + 2 TB NVMe</p>
                <p>Memory</p>
                <p className="font-normal">512 GB</p>
                <p>Network</p>
                <p className="font-normal">
                  Dual 10Gbps NICs with 300 Mbps commit, burstable
                </p>
            ...
            <Item title="Edgevana – AMD Milan 7413 - 7413-256G-1G">
              <div className="grid grid-cols-2 gap-2">
                <p>CPU</p>
                <p className="font-normal">AMD Milan 7413 EPYC</p>
                <p>Cores</p>
                <p className="font-normal">24 cores @ 2.65 GHz</p>
                <p>Boot</p>
                <p className="font-normal">1 x 480 GB SSD</p>
                <p>Storage</p>
                <p className="font-normal">1 TB NVMe + 2 TB NVMe</p>
                ...
                <p>Network</p>
                <p className="font-normal">
                  Dual 1Gbps NICs with 300 Mbps commit, burstable
                </p>
                <p>Security</p>
                <p className="font-normal">
                  DDOS Protection Included on all servers
            ...
            <Item title="Edgevana – AMD Milan 7413 - 7413-512G-10G">
              <div className="grid grid-cols-2 gap-2">
                <p>CPU</p>
                <p className="font-normal">AMD EPYC</p>
                <p>Cores</p>
                <p className="font-normal">24 cores @ 2.8 GHz</p>

                <p>Storage</p>
                <p className="font-normal">2 x 240 GB SDD + 2 x 3.8TB NVMe</p>
                <p>Memory</p>
                <p className="font-normal">256</p>
                <p>Network</p>
                <p className="font-normal">
                  2 x 10 Gbps w/ 64TB of bundled outbound transfer (Inbound FoC)
                </p>
                <p>OS</p>
            ...
            <Item title="Equinix – w3amd.75xx24c. 256.4320.x86">
              <div className="grid grid-cols-2 gap-2">
                ...
                <p className="font-normal">AMD EPYC</p>
                <p>Cores</p>
                <p className="font-normal">24 cores @ 3.0 GHz</p>

                <p>Storage</p>
                <p className="font-normal">2 x 240 GB SDD + 1 x 3.8TB NVMe</p>
                <p>Memory</p>
                <p className="font-normal">256</p>
                <p>Network</p>
                <p className="font-normal">
                  2x 25 Gbps w/ 64TB of bundled outbound transfer (Inbound FoC)
                </p>
                <p>OS</p>
                <p className="font-normal">Ubuntu</p>
              </div>
            ...
            <Item title="StackPath – SV1">
              <div className="grid grid-cols-2 gap-2">
                ...
                <p className="font-normal">AMD EPYC</p>
                <p>Cores</p>
                <p className="font-normal">32 cores @ 3.2 GHz</p>

                <p>Storage</p>
                <p className="font-normal">1920 GB NVMe</p>
                <p>Memory</p>
                <p className="font-normal">256 GB</p>
                <p>Network</p>
                <p className="font-normal">
                  Redundant 25Gb connectivity with 64.8TB of included bandwidth
                </p>
                <p>OS</p>
                <p className="font-normal">CentOS, Debian, Ubuntu</p>
              </div>
            </Item>
            <Item title="StackPath – SV1">
              <div className="grid grid-cols-2 gap-2">
