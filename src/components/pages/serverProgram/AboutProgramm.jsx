    ...
    <div>
      <div className="px-4 py-5 sm:py-14 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-lg md:px-24 lg:px-5">
        ...
        <article className="my-3">
          This optional program is designed to foster sustainable growth in the
          validator and RPC community, and further decentralize the Solana
          network.
        </article>
        ...
        <div>
          ...
          <div className="flex my-10">
            ...
            <div className="w-16 mr-4 border-r-2 text-[40px] font-medium border-gray-300 my-2">
              1
            </div>
            ...
            <div className="flex-1">
              ...
              Customer”) process at this point. The KYC process is necessary to
              participate in the program.
            </div>
          </div>
          {/* 2nd */}
          <div className="flex my-10">
            <div className="w-16 mr-4 w-16 mr-4 hidden sm:block">{/* 3rd */}</div>
            <div className="w-16 mr-4 border-r-2 text-[40px] font-medium border-gray-300 my-2">
              2
            </div>

            <div className="flex-1">
              Eligible individuals will then receive a welcome email and Server
              Program Agreement (SPA) which will be sent to the email provided.
            </div>
          </div>

          <div className="flex my-10">
            <div className="w-16 mr-4 w-16 mr-4 hidden sm:block"></div>
            <div className="w-16 mr-4 border-r-2 text-[40px] font-medium border-gray-300 my-2">
              3
            </div>

            <div className="flex-1">
              Once the SPA is signed, individuals will be connected with one of
              the participating data center providers in order to get access to
              the server(s).
        ...
        <div>
          ...
          <div className="flex my-10">
            <div className="w-16 mr-4">
              <h1 className="text-[20px] sm:text-[48px] font-semibold">FAQs</h1>
            </div>
            <div className="sm:w-16 mr-4 border-r-2 text-[40px] font-medium border-gray-300 my-2">
            ...
            <div className="flex-1 text-lg font-semibold">
              ...
              <div className="flex-1 text-lg font-semibold">
                ...
                <span className="font-light text-[16px]">
                  The Solana Foundation has engaged with Edgevana, Equinix, and
                  Stackpath, and will be announcing other data center providers
                  later this year as they come online.
                </span>
                <br />
                <br />
              </div>
              ...
              <div className="flex-1 text-lg font-semibold">
                ...
                <span className="font-light text-[16px]">
                  All servers have been spec’d to meet the needs of the network
                  with a long term view. These specs should be sufficient for
                  both RPC and Validator nodes.
                </span>
                <br />
                <br />
              </div>
              ...
              <div className="flex-1 text-lg font-semibold">
                ...
                <span className="font-light text-[16px]">
                  ...
                  though it can get done in as little as one day. The Foundation
                  has tried to make it as simple as possible to help individuals
                  get access to infrastructure in a timely manner.
                </span>
                <br />
                <br />
              </div>
              ...
              <div className="flex-1 text-lg font-semibold">
                ...
                <span className="font-light text-[16px]">
                  This special infrastructure and pricing is only available with
              ...
              <br />
              <div className="flex-1 text-lg font-semibold">
                Does the Solana Foundation profit from the sales of hardware by
                partners in this program? <br /> <br />{" "}
                <span className="font-light text-[16px]">
                  No. The Solana Foundation has committed to enabling this
                  program through a bulk purchasing agreement. The Foundation
                  does not receive kickbacks or profit sharing with third party
                  data centers in any way. The Solana Foundation is a non-profit
                  on a mission to help build the most censorship resistant
                  network possible.
                </span>
                <br />
                <br />
              ...
              <div className="flex-1 text-lg font-semibold">
                ...
                <span className="font-light text-[16px]">
                  You’re responsible for the ongoing maintenance and security of
                  the servers you deploy with the Data Center partners. This
                  includes securing each server, and responding to any exploits,
                  abuses, or other behaviors that are prohibited under the Data
                  Center partners MSA. You are also responsible for any terms
                  and conditions required by the third party data centers.
                </span>
                <br />
                <br />
              </div>
              ...
              <div className="flex-1 text-lg font-semibold">
                **All participants in the Server Program are subject to the
                ...
                as well as the terms and conditions required by any data center
                participant in the program. <br /> <br />
                <br />
                <br />
              </div>
            </div>
